...
async def analyze_scan(analysis_request: AnalysisRequest):
    ...
    try:
        ...
        The scan was performed on the domain: {scan_result.get('domain')}
        ...
        # Fallback to a simpler analysis if Ollama fails
        return {
            "analysis": f"Analysis of {scan_result.get('domain')} failed due to an error. Please try again later or contact support."
        }
